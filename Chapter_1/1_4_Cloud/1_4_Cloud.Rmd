...
+ EC2: allows you to rent virtual servers, referred to as instances, with configurable amounts of CPU, memory, storage, and networking capacity
+ S3: 
+ SSH:
**Amazon Simple Storage Service (S3)**, keeps your data safe and accessible regardless of whether your instance is running or not, making it ideal for long-term storage of datasets, results, and backups. Temporary storage, such as **Amazon Elastic Block Store (EBS)** or local instance storage, is only available while your instance is active and is used during computation to hold intermediate files and data that require fast read and write access.
