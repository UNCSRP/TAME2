...
+ **Option 1: AWS Systems Session Manager**
...
knitr::include_graphics("Chapter_1/1_4_Cloud/aws_terminal.png")
```
...
```{r 1-4-Cloud-17, echo=FALSE, out.width = "100%",fig.align='center'}
