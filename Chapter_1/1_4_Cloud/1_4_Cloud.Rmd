...
Additionally, we'll be making use of the ELISA dataset used in the previous module, **1.4 Data Wrangling in Excel**, to walk through some of these steps. Further description of the dataset can be found there. 
...
```{r 1-4-Cloud-3, echo=FALSE, out.width = "80%",fig.align='center'}
knitr::include_graphics("Chapter_1/1_4_Cloud/iam.png")
```
...
knitr::include_graphics("Chapter_1/1_4_Cloud/data_upload.png")
```
...
knitr::include_graphics("Chapter_1/1_4_Cloud/ec2_dashboard.png")
```

**Step 2: Name Your Instance**
Enter a descriptive name for your instance in the "Name" field at the top of the page, such as "Allostatic Analysis". This helps you identify it later if you have multiple instances running.
...
```{r 1-4-Cloud-9, echo=FALSE, out.width = "100%",fig.align='center'}
knitr::include_graphics("Chapter_1/1_4_Cloud/ami.png")
```
...
```{r 1-4-Cloud-10, echo=FALSE, out.width = "100%",fig.align='center'}
knitr::include_graphics("Chapter_1/1_4_Cloud/instance_type.png")
```
...
```{r 1-4-Cloud-11, echo=FALSE, out.width = "100%",fig.align='center'}
knitr::include_graphics("Chapter_1/1_4_Cloud/key_pair.png")
```
...
```{r 1-4-Cloud-12, echo=FALSE, out.width = "100%",fig.align='center'}
knitr::include_graphics("Chapter_1/1_4_Cloud/iam_assignment.png")
```
...
```{r 1-4-Cloud-13, echo=FALSE, out.width = "100%",fig.align='center'}
...
> **Note:** If you are using an Ubuntu AMI, replace `ec2-user` with `ubuntu`. For other AMIs, the default username may vary — check the AMI documentation if you are unsure.
...
```{r 1-4-Cloud-14, echo=FALSE, out.width = "100%",fig.align='center'}
knitr::include_graphics("Chapter_1/1_4_Cloud/ec2_connect.png")
```
...
```{r 1-4-Cloud-15, echo=FALSE, out.width = "100%",fig.align='center'}
...
```{r 1-4-Cloud-16, echo=FALSE, out.width = "100%",fig.align='center'}
