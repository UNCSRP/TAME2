...
```{r, install__libs, echo=TRUE, eval=FALSE, warning=FALSE, results='hide', message=FALSE}
...
```{r}
tables <-tabulapdf::extract_tables("Module4_3_Input/Module4_3_InputData4.pdf", output = "tibble")
```
...
#### Cleaning the global environment
```{r, clear__env, echo=TRUE, eval=FALSE}
rm(list=ls())
```
