# 5.1 Introduction to Artificial Intelligence & Machine Learning for Environmental Health
...
+ Provide an overview of the intersection between environmental health science ML through discussing...
    + Why there is a need for AI/ML in environmental health science
    + Provide guidance for integrating generative AI into scientific research
...
> **Note**: AI can be categorized in different ways and may deviate from what is illustrated below.
...
### Impact and Integration of Generative AI into Scientific Research

By learning from massive amounts of data, Generative AI is able to create content, including but not limited to images, photos, videos, text, and code. One of the most popular generative AI platforms, **ChatGPT (Chat Generative Pre-trained Transformer)** is a publicly available chatbot developed by OpenAI. It was released in November of 2022 and quickly gained popularity due to its accessibility and ability to have human-like conversations with the user across almost any imaginable topic. Other generative AI platforms include Claude, ChatGPT's Codex, Google's Gemini, and Microsoft's Copilot. 
...
The role of ChatGPT and similar tools in the environmental health research space is still being explored. Although ChatGPT has the potential to streamline certain parts of the research process, such as text and language polishing, synthesizing existing information, and suggesting custom coding solutions, it is not an intellectual replacement for the expertise and diverse viewpoints of scientists and must be used transparently and with caution. For example, using AI to transform the structure of your data is a great way to incorporate it into workflows. However, using AI to draw inferences from analyses on niche topics with few peer-reviewed articles or having AI write all your code as someone who is a beginner-level programmer is not advised. These platforms make mistakes often, so it is recommended to incorporate AI under circumstances that can be easily verified.

UNC has issued a [Research Generative AI Guidance](https://ai.unc.edu/research-generative-ai-usage-guidance/), which offers a more comprehensive overview of incorporating generative AI into research practices. Also, check out this paper on the [Ten simple rules for optimal and careful use of generative AI in science](https://pmc.ncbi.nlm.nih.gov/articles/PMC12561928/). 
...
In conclusion, this training module provides an overview of the field of AI and ML and discusses applications of these tools in environmental health science. These methods represent common tools that are used in high dimensional data analyses within the field of environmental health sciences.
