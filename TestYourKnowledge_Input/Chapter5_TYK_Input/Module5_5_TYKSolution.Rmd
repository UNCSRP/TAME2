# TYK Solution for TAME 2.0 Module 5.5, Unsupervised Machine Learning: Additional Clustering Applications

<br.

## TYK Questions

Using the same dataset as in the module (Module5_5_TYKInput.xlsx), answer the questions below. 
...
```{r}
# Reading in file
cytokines_df = data.frame(read_excel("Module5_5_TYKInput.xlsx", sheet = 2))
