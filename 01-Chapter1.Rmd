...
knitr::include_graphics("Module1_1_Input/Module1_1_Image1.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image1.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image2.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image3.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image4.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image5.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image6.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image7.png")
```
...
**Wide Format**
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image8.png")
```
...
**Long Format**
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image9.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image10.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image11.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image12.png")
```

8. To save this, go back to the "Home" tab and click "Close & load". You should see something similar to the screenshot below. 
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image13.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image14.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image15.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image16.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_4_Input/Module1_4_Image17.png")
```
